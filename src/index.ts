...
export let bodyElement: HTMLElement = document.body;
...
window.addEventListener('DOMContentLoaded', () => {
	...
	new EdgeLinkButton(bodyElement, SVGs.coffee, '#FBAA19', 64, -8, 'https://ko-fi.com/martintale?ref=js13kgames2023-entry');

	soundToggle = new EdgeButton(bodyElement, SVGs.sound, 'sound', 8, 8);

	if (import.meta.env.MODE === 'development') {
		new EdgeLinkButton(bodyElement, `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path d="m1.6 11.4-1.5-1 5.4-.6 1.9 5-1.5-1c-1.5 2.4-2.9 5.2-2 8C1.4 19.5 0 18 0 16c0-1.4 1-3.3 1.6-4.6zm4 5.6c-.7 1-1 2.9-.7 4 .1.6.6 1 1.2 1H11v-5H5.7zm10.8 5.2V24L13 19.7l3.4-4.2v1.8c2.8 0 5.8-.4 7.6-2.5-.5 3.2-1.1 5.3-2.8 6.3-1.2.8-3.4 1-4.8 1zm2.7-6.4a6 6 0 0 0 3.8-1.5c.4-.4.5-1 .2-1.5l-2.6-4.2-4.3 2.6 2.8 4.6zM18 4.2l1.6-.9-2 5-5.4-.7 1.6-.9c-1.4-2.4-3.2-5-6-5.6C10 .4 11.5 0 12.8 0c2.2 0 3.5 1.3 5.4 4.2zm-6.9.8c-.4-1.1-2-2.3-3.2-2.6-.5-.2-1 0-1.3.5L4.3 7.2l4.3 2.4L11.2 5z"/></svg>`, '#f00', -8, -8, () => {
			resetState();
		});
	}
