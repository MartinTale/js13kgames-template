...
export function setGameColor(newHexColor: string) {
	...
	const bg = 'rgb(' + (Math.max(0, rgbColor.r * 0.25)) + ',' + (Math.max(0, rgbColor.g * 0.25)) + ',' + (Math.max(0, rgbColor.b * 0.25)) + ')';
	const color = 'rgb(' + (Math.min(255, rgbColor.r * 1.5)) + ',' + (Math.min(255, rgbColor.g * 1.5)) + ',' + (Math.min(255, rgbColor.b * 1.5)) + ')';
	const shadow = 'rgb(' + (Math.min(255, rgbColor.r * 1.2)) + ',' + (Math.min(255, rgbColor.g * 1.2)) + ',' + (Math.min(255, rgbColor.b * 1.2)) + ')';
